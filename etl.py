...
# We here want to process the songs data files and create extract songs table and artist table data from it.
...
# We want here to process the event log file and extract data for table time, users and songplays from it.
